...
internal sealed class Channel4(int baseAddress, Operator o1, Operator o2, Operator o3, Operator o4, FmSynthesizer opl) : Channel(baseAddress, opl)
{
    private readonly Operator op1 = o1;
    private readonly Operator op2 = o2;
    private readonly Operator op3 = o3;
    private readonly Operator op4 = o4;
