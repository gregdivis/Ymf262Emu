...
internal class Channel2(int baseAddress, Operator o1, Operator o2, FmSynthesizer opl) : Channel(baseAddress, opl)
{
    public readonly Operator op1 = o1;
    public readonly Operator op2 = o2;
